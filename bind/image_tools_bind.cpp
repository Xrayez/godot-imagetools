...
bool _ImageTools::bucket_fill(Ref<Image> p_image, const Point2 &p_at, const Color &p_fill_color, Ref<Image> p_fill_image, KernelConnectivity p_kc) {
...
void _ImageTools::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("bucket_fill", "image", "at", "fill_color", "fill_image", "connectivity"), &_ImageTools::bucket_fill, DEFVAL(KERNEL_FOUR_WAY));
